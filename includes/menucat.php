<?php
	...
	class Menucat extends DatabaseObject {
	protected static $table_name="menucat";
	protected static $db_fields=array('id','name','status');
	protected static $db_value=array(':id'=>'id',':name'=>'name',':status'=>'status');
	
    public $id;
    public $name;
    public $status;
    protected $folder="menucat";
    public $errors=array();
