...
class forms
	{
	protected static $wtform=9;
	protected static $wtlable=3;
		 
		 public static function form_start()
		{
			$x = '<form class="form-horizontal" action="#" enctype="multipart/form-data" method="POST"  data-toggle="validator" role="form" autocomplete="off">';
		return $x;
		}
		...
		{
		$x = '<div class="form-group row  col-md-12 text-right"><button type="submit" name="submit" class="btn btn-danger btn-sm waves-effect waves-light">Clean Cache Memory</button>
		</div>';
		return $x;
		}
	  ...
	  return $res;
		...
		<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label text-right ">'.$lable.''.$res.':</label>
			...
			public static function date_mm_range($lable="", $name="", $value = "",$id,$n)
		{
			$re=self::check($n);
		 $res=self::checkst($n);
		$x = '<div class="form-group row  row">
										<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label text-right ">'.$lable.''.$res.':</label>
										<div class="col-md-'.self::$wtform.'">
...
CKEDITOR.replace( '".$idname."', {
	...
	extraPlugins: 'widgetbootstrap'	
		...
		{
		$x = '<div class="form-group row ">
								<label for="exampleInputFile" class="col-md-'.self::$wtlable.' control-label text-right ">'.$lable.':</label>
<div class="col-md-'.self::$wtform.'">
		...
		{
			//echo $_SERVER['DOCUMENT_ROOT']."/".MYF.$path;	
		$x = '<div class="form-group row ">
								<label for="exampleInputFile" class="col-md-'.self::$wtlable.' control-label text-right ">'.$lable.':</label>
<div class="col-md-'.self::$wtform.'">';
					...
					if($image!='')
{
		...
		<img  src="'.BASE_PATH.$path.'"  /></a></div>
							 ...
							 }else
			{
				...
				$x.= '<div class="input-group image-preview'.$image.'">
                <input type="text" class="form-control image-preview-filename'.$image.'" disabled="disabled">
                <span class="input-group-btn">
                    <!-- image-preview-clear button -->
                    <button type="button" class="btn btn-default image-preview-clear'.$image.'" style="display:none;">
                        <span class="glyphicon glyphicon-remove"></span> Clear
                    </button>
                    <!-- image-preview-input -->
                    <div class="btn btn-default image-preview-input">
		...
		{
		$x = '<div class="form-group row ">
								<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label text-right ">'.$lable.':</label>
								<div class="col-md-'.self::$wtform.'">';
...
{			
		...
		public static function Select_n($lable="",$name="",$table)
	{
		...
		$x = '<div class="form-group row "><label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label text-right ">'.$lable.':</label>
		<div class="col-md-'.self::$wtform.'">
