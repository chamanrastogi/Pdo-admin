<?php
	...
	class Menu_type extends DatabaseObject {
	protected static $table_name="menu_type";
	protected static $db_fields=array('id','name','image','text','created','updated','status');
	protected static $db_value=array(':id'=>'id',':name'=>'name',':image'=>'image',':text'=>'text',':created'=>'created',':updated'=>'updated',':status'=>'status');
