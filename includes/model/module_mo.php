<?php
	...
	class Module_mo extends Module {    
	public function add()
	{
		include_layout_admin('header.php');
			...
			echo $fo=Forms::input("Link Url","link",$link,0);
			echo $fo=Forms::textarea("Text","text",$text,'',0);
			echo $fo=Forms::image("Upload image","image");
			echo $fo=Forms::text_editor("Description","ftext",$ftext,'editors','editors');	  
    ...
    public function edit()
	{
		...
		$table=self::$table_name;
			...
			echo $fo=Forms::input("Name","name",$name,1);
			echo $fo=Forms::input("Heading","heading",$pheading,1);
			echo $fo=Forms::input("Link Url","link",$link,0);
			echo $fo=Forms::textarea("Text","text",$text,'',0);
