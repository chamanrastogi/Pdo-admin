<?php
	...
	protected static $db_fields=array('id','name','heading','link','text','image','ftext','status');
	protected static $db_value=array(':id'=>'id',':name'=>'name',':heading'=>'heading',':link'=>'link',':text'=>'text',':image'=>'image',':ftext'=>'ftext',':status'=>'status');
